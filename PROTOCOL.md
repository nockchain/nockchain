...
- Proposed emergency activation: [`015-zoe.md`](./changelog/protocol/015-zoe.md), version `0.1.15`, activation height `120400`, target `2026-08-07`.
...
| --- | ---------------------------------------- | ------- | ---------- | ----------------- | ----------------- | ----------------------------------------------------------------------------------------------------- |
| 015 | Zoe                                      | 0.1.15  | draft      | 120400            | 2026-08-07        | [`015-zoe.md`](./changelog/protocol/015-zoe.md)                                                       |
