...
++  inner
  ...
  ++  load
    ...
    ++  state-n-to-11
      ...
      arg
    ::
    ::  Upgrade kernel state 10 with all metadata required by the dual-puzzle
    ::  regime. Branch-local lineage cannot be reconstructed after activation,
    ::  so such a state must not be loaded under a different target rule.
    ++  state-10-to-11
